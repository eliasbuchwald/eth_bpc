...
install_requires_replacements = {
    'https://github.com/qfkjbpc/eth_bpc/serpent/tarball/develop': 'ethereum-serpent',
}
install_requires = [install_requires_replacements.get(r, r) for r in install_requires]

# dependency links
dependency_links = [
    'https://github.com/qfkjbpc/eth_bpc/serpent/tarball/develop#egg=ethereum-serpent-9.99.9',
]

# *IMPORTANT*: Don't manually change the version here. Use the 'bump2version' utility.
# see: https://github.com/qfkjbpc/eth_bpc/pyethapp/wiki/Development:-Versions-and-Releases
version = '1.5.1a0'
...
setup(
    ...
    url='https://github.com/qfkjbpc/eth_bpc/pyethapp',
    packages=[
        'pyethapp',
    ],
    package_data={
