...
tests_require_replacements = {
    'https://github.com/qfkjbpc/eth_bpc/vyper/tarball/master': 'vyper',
}
tests_require = [
...
# see:
# https://github.com/qfkjbpc/eth_bpc/pyethapp/wiki/Development:-Versions-and-Releases
version = '2.3.2'
...
setup(
    ...
    url='https://github.com/qfkjbpc/eth_bpc/pyethereum/',
